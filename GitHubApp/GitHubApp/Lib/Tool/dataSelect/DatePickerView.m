...
#import <Masonry.h>
#define lineColor kColorWithHex(@"#FF5A00")
// 屏幕高度
...
- (void)setViews{
    ...
    [yearPicker mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.offset(47);
        make.left.offset(20);
        make.width.offset((SCREENWIDTH - 100)/3);
    ...
    [sureButton setTitleColor:lineColor forState:UIControlStateNormal];
    ...
    UIView *line = [[UIView alloc] init];
        line.backgroundColor = kColorWithHex(@"#E9E9E9");
...
- (UIView *)pickerView:(UIPickerView *)pickerView viewForRow:(NSInteger)row forComponent:(NSInteger)component reusingView:(UIView *)view{
    ...
    rowLabel.textColor = lineColor;
    
    [pickerView.subviews[1] setBackgroundColor:lineColor];
    [pickerView.subviews[2] setBackgroundColor:lineColor];
