...
//水印图位置
typedef NS_ENUM (NSUInteger,WatermarkPicturePositon) {
    WatermarkPicturePositonTopLeft,     //上左
    WatermarkPicturePositonTopMid,      //上中
    WatermarkPicturePositonTopRight,    //上右
    WatermarkPicturePositonMidLeft,     //中左
    WatermarkPicturePositonMid,         //中心
    WatermarkPicturePositonMidRight,    //中右
    WatermarkPicturePositonDownLeft,    //下左
    WatermarkPicturePositonDownMid,     //下中
    WatermarkPicturePositonDownRight    //下右
};
...
/**
 ...
 @param baseImage   原图
 @param markImage   要加的水印图
 @param position    要加的position
 @param alpha       生成的水印图alpha
 @return            水印图
 */
