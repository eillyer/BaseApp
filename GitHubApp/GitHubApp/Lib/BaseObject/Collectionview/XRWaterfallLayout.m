...
- (void)prepareLayout {
    ...
    CGFloat sectionHeight = self.topHeight == 0 ? self.sectionInset.top : self.topHeight;
    
    for (int i = 0; i < self.columnCount; i++) {
        self.maxYDic[@(i)] = @(sectionHeight);
    }
    // 2.计算所有cell的属性
    ...
    if (sectionHeight > 0) {
        ...
        layoutHeader.frame =CGRectMake(0,0, screenW, sectionHeight);
